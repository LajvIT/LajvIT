...
<h1>
<? echo $this->events[$this->eventid]->shortname; ?>
...
<form action="index.php" method="post" name="characterDeleteForm">
	<input type="submit" value="Ta bort karaktär" /> <input type="hidden" name="option"
		...
		value="<? echo $this->characterid; ?>" /> <input type="hidden" name="Itemid"
		value="<? echo $this->itemid; ?>" /> <input type="hidden" name="redirect"
		value="<? echo $this->redirect; ?>" />
</form>
