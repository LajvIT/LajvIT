...
?>
      ...
      <tr>
        <td>
          <a href="index.php?option=com_lajvit&view=plot&eid=<?php echo $this->eventId; ?>&pid=<?php echo $this->plotId; ?>&layout=subplot" title="Add subplot">Lägg till delintrig <img src="media/com_lajvit/images/new_character.png" alt="Lägg till" /></a>
        </td>
      </tr>
      <tr><td></td></tr>
    </tbody>
...
function printPlotObjectHeaderAndDescription($plotObject, $eventId) {
  ...
  echo '<a href="index.php?option=com_lajvit&view=plot&eid='. $eventId .'&pid='. $plotObject->id .'&layout=subplot" title="Edit subplot"><img src="media/com_lajvit/images/edit_character.png" alt="Redigera" /></a>';
  echo "</td>\n";
  echo "        </tr>\n";
  echo "        <tr>\n";
